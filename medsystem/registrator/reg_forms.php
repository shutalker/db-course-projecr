                                ...
                                <div class="nav">
                                    <ul>
                                        <li>
                                            ...
                                            <ul class="hf-bg brd">
                                                <li>
                                                    <a class="nav-btn block" href="./reg_registrate_controller.php?tomain=1">Главное меню</a>
                                                </li>
                                                <li>
                                                    <a class="nav-btn block" href="./reg_registrate_controller.php?out=1">Выход</a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
                ...
                <div class="main">
                    <div class="main-content clear">
                        <div class="welcome-label">
				            <h3 class='hx'>Запись на приём к врачу</h3>
				        </div>
                        <div class="main-content-left left-float">
                            <div class="content-window brd">
                                <div class="option-list">
                                    <ul id="optList">
                                        <li>
                                            <span id="1" class="btn opt-btn">К конкретному врачу</span>
                                        </li>
                                        <li>
                                            <span id="2" class="btn opt-btn">На удобное время</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
